...
//    }
    ...
    public void firebaseSetting() throws IOException {
        GoogleCredentials googleCredentials = GoogleCredentials.fromStream(new ClassPathResource("config/divide-e7a2a-firebase-adminsdk-sau8w-bc2884c85c.json").getInputStream())
